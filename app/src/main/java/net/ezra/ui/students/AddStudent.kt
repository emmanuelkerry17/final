...
fun uploadImageToFirebaseStorage(imageUri: Uri, studentName: String, studentClass: String, studentid:String, studentresidence:String) {
    ...
    uploadTask.continueWithTask { task ->
        ...
        if (task.isSuccessful) {
            ...
            saveToFirestore(downloadUri.toString(), studentName, studentClass,studentresidence,studentid)
        } else {
...
fun saveToFirestore(imageUrl: String, studentName: String, studentClass: String,studentid: String,studentresidence: String) {
